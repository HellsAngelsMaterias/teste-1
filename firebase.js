 ...
 * e exportar as dependências (auth, db) e funções.
 * =================================================== */
...
// Exportar instâncias principais
export { auth, db };

// Exportar funções do Auth para não precisar importar em todo arquivo
export { 
...
// Exportar funções do Database para não precisar importar em todo arquivo
export { 
    ref, 
    set, 
    push, 

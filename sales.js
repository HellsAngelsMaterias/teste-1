...
import { db, ref, set, push, remove } from '../config/firebase.js';
import { perUnit, valores, valorDescricao } from '../config/constants.js';
import { getQty, formatCurrency, capitalizeText, showToast, toggleView, copyToClipboard } from '../utils/helpers.js';
